const API_URL = "https://e87b44fb8ea362b1-102-18-159-59.serveousercontent.com";
...
function setLanguage(lang, event) {
    ...
    const t = i18n[lang];
    if(document.getElementById('lbl_reg_email')) document.getElementById('lbl_reg_email').innerText = t.reg_email;
    if(document.getElementById('lbl_reg_country')) document.getElementById('lbl_reg_country').innerText = t.reg_country;
    if(document.getElementById('lbl_reg_phone')) document.getElementById('lbl_reg_phone').innerText = t.reg_phone;
    if(document.getElementById('lbl_reg_pass')) document.getElementById('lbl_reg_pass').innerText = t.reg_pass;
    if(document.getElementById('lbl_reg_pass2')) document.getElementById('lbl_reg_pass2').innerText = t.reg_pass2;
    if(document.getElementById('btn_register')) document.getElementById('btn_register').innerText = t.btn_register;
    if(document.getElementById('lnk_to_login')) document.getElementById('lnk_to_login').innerText = t.lnk_to_login;

    if(document.getElementById('lbl_login_id')) document.getElementById('lbl_login_id').innerText = t.login_id;
    if(document.getElementById('lbl_login_pass')) document.getElementById('lbl_login_pass').innerText = t.login_pass;
    if(document.getElementById('btn_login')) document.getElementById('btn_login').innerText = t.btn_login;
    if(document.getElementById('lnk_to_reg')) document.getElementById('lnk_to_reg').innerText = t.lnk_to_reg;

    if(document.getElementById('lbl_solde1')) document.getElementById('lbl_solde1').innerText = t.solde1;
    if(document.getElementById('lbl_solde2')) document.getElementById('lbl_solde2').innerText = t.solde2;

    if(document.getElementById('lbl_act_nom')) document.getElementById('lbl_act_nom').innerText = t.act_nom;
    if(document.getElementById('lbl_act_prenom')) document.getElementById('lbl_act_prenom').innerText = t.act_prenom;
    if(document.getElementById('lbl_act_sexe')) document.getElementById('lbl_act_sexe').innerText = t.act_sexe;
    if(document.getElementById('lbl_act_country')) document.getElementById('lbl_act_country').innerText = t.act_country;
    if(document.getElementById('lbl_act_phone')) document.getElementById('lbl_act_phone').innerText = t.act_phone;
    if(document.getElementById('btn_act_submit')) document.getElementById('btn_act_submit').innerText = t.act_submit;
...
async function submitRegister() {
    ...
    try {
        ...
        alert("Tsy mahatratra ny server! Hamarino ny Pinggy/Termux connection.");
        console.error(err);
    }
}
...
async function submitActivation() {
    ...
    try {
        ...
        alert("Erreur serveur lors de l'activation");
    }
}
